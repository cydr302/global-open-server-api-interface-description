...
- https://SERVER_URL/api/open/v1/rt2/pause
...
|maxWaitTime |No  |Integer | The maximum pause waiting time (seconds), no more than 3 minutes, after timeout, the device is reset. If it is not passed, it is 60 seconds by default.    |
...
|RT2_NOT_WASHING    |Not in washing|
