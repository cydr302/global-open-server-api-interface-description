...
- Used to end the car wash in the device
- After a successful call , washer end the work and send the FINISH_WASH callback
...
- https://SERVER_URL/api/open/v1/sht2/closeOrder
...
|orderId |Yes  |String | Same as working order.    |
